...
// new CFW "flash plugins"
#define MAX_PLUGINS 8
#define PF_VSH 0x00000001
#define PF_GAME 0x00000002
...
// new CFW definitions
#define CF_MAGIC 0x5746676B
#define CF_VERSION 0x00010000
// CFW config flags
#define CF_SKIPGAMEBOOT 0x00000001
#define CF_HIDEMAC 0x00000002
#define CF_USEVSHMENU 0x00000004
#define CF_HIDEPICTURE 0x00000008
#define CF_SLIMCOLOR 0x00000010
#define CF_USBCHARGE 0x00000010
#define CF_FASTSCROLL 0x00000020
#define CF_FLASHPROTECT 0x00000040
#define CF_USBNAME 0x00000080

typedef struct {
	int magic; // "kgFW"
	int version; // CF_VERSION
	unsigned int flags; // ON/OFF items
	int vshcpuspeed;
	int vshbusspeed;
	int gamecpuspeed;
	int gamebusspeed;
	int fakeregion;
	int reserved[4]; // for future use, maybe
	flash_plugin plugins[MAX_PLUGINS];
} CFWconf;
...
extern int sctrlSESetConfigEx(CFWconf *config, int size);

/* 0x0000325C */
/* SystemCtrlForUser_1DDDAD0C SystemCtrlForKernel_1DDDAD0C */
extern int sctrlSESetConfig(CFWconf *config);
...
extern void SetConfig(CFWconf *config);
...
/* 0x00002C90 */
/* VshCtrlLib_CD6B3913 */
extern int vctrlVSHExitVSHMenu(CFWconf *conf);
